...
echo "------------------------------------------------------------------------------"
echo "[Rebuild] rest-api-handler"
echo "------------------------------------------------------------------------------"
cd $source_dir/rest-api-handler
npm run build
cp ./dist/rest-api-handler.zip $build_dist_dir/rest-api-handler.zip

echo "------------------------------------------------------------------------------"
echo "[Rebuild] solution-helper"
echo "------------------------------------------------------------------------------"
...
echo "------------------------------------------------------------------------------"
echo "[Rebuild] static-assets"
echo "------------------------------------------------------------------------------"
cd $source_dir/static-assets
zip -rq static-assets.zip .
mkdir dist && mv static-assets.zip dist/
cp ./dist/static-assets.zip $build_dist_dir/static-assets.zip
